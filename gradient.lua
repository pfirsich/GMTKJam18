...
local gradient = {
    {y = 0, color = {0, 0, 0}},
    {y = 0.3, color = {0, 0.278, 0.533}},
    {y = 0.5, color = {0, 0.58, 0.733}},
    {y = 0.7, color = {0.17, 0.764, 0.831}},
    {y = 0.9, color = {0.89, 0.796, 0.624}},
    {y = 1.0, color = {0.733, 0.384, 0.251}},
}
...
return love.graphics.newImage(gradientData)
